export const articleModel = {
  GETALL:
    "SELECT a.id as art_id,a.image, a.title, a.description, a.likes,a.views,a.add_date,u.username,u.avatar,u.profession,u.id user_id\
        FROM articles as a \
        INNER JOIN users as u ON (a.user_id = u.id)\
        where a.permission = true\
        GROUP BY a.id , u.username, u.avatar,u.profession,u.id",
  GET: "SELECT a.id as art_id,a.image, a.title, a.description, a.likes,a.views,a.add_date,u.username,u.avatar,u.profession,u.id user_id\
  FROM articles as a \
  INNER JOIN users as u ON (a.user_id = u.id)\
  ...
  ADMINGET: "SELECT * FROM articles where id = $1",
  ADMINPOST:
